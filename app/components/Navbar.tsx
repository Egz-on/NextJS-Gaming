...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-b border-purple-500/20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-4">
                        {!user && (
                            <>
                                <a href="/login" className="group relative px-6 py-2 text-white font-medium transition-all duration-300 hover:scale-105 hover:-translate-y-0.5">
                                ...
                                <a href="/register" className="group relative px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg transition-all duration-300 hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-purple-500/25 active:scale-95">
            ...
            <div className="absolute top-0 right-4 w-2 h-2 bg-red-400 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
        </nav>
    )
}
