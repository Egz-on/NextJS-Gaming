...
"[project]/components/LoginFrom.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LoginFrom() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
                email,
                password
            });
...
_s(LoginFrom, "wrLlx+MRsFOmmhjTuw2VMmR79HQ=", false, function() {
    return [
...
//# sourceMappingURL=components_LoginFrom_tsx_6a88b03a._.js.map