...
;
;
const AuthContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$vm$2d$browserify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])();
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            if (savedToken) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyToken"])(savedToken).then({
                    "AuthProvider.useEffect": (data)=>{
                        setToken(savedToken);
                        setUser(data.user);
                    }
                }["AuthProvider.useEffect"]).catch({
                    "AuthProvider.useEffect": ()=>localStorage.removeItem('auth-token')
                }["AuthProvider.useEffect"]).finally(setLoading(false));
            } else {
                setLoading(false);
            }
        }
...
_s(AuthProvider, "yQlAhsmqiq8TzQzByPbQZzI4AZI=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_220434bc._.js.map