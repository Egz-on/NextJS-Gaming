...
"[project]/app/components/StarRating.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function StarRating({ value, readOnly = true }) {
    const stars = Array(5).fill(0).map((_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: i < Math.round(value) ? 'text-yellow-400' : 'text-gray-300',
            children: "★"
        }, i, false, {
            fileName: "[project]/app/components/StarRating.tsx",
            lineNumber: 11,
            columnNumber: 9
        }, this));
...
//# sourceMappingURL=app_d4418ddb._.js.map