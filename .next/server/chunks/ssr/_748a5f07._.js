...
async function SideBar() {
    ...
    try {
        const fetchLastGame = await fetch(` https://api.rawg.io/api/games?key=${apiKey}&ordering=-released&page_size=1`);
        const data = fetchLastGame.json();
        console.log(data);
    } catch (error) {
        console.log(error);
    }
...
//# sourceMappingURL=_748a5f07._.js.map