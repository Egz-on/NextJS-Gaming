...
;
;
const AuthContext = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$vm__$5b$external$5d$__$28$vm$2c$__cjs$29$__["createContext"])();
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (savedToken) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["verifyToken"])(savedToken).then((data)=>{
                setToken(savedToken);
                setUser(data.user);
...
function useAuth() {
    ...
    if (!context) {
        throw new __TURBOPACK__imported__module__$5b$externals$5d2f$console__$5b$external$5d$__$28$console$2c$__cjs$29$__["error"]('useAuth must be used within an AuthProvider ');
    }
    return context;
}
2;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6480a085._.js.map